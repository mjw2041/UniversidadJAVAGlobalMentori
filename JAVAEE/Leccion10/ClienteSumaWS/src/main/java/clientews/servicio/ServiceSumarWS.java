 ...
 * 
 */
@WebService(name = "ServiceSumarWS", targetNamespace = "http://beans/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ServiceSumarWS {
    ...
    @Action(input = "http://beans/ServiceSumarWS/sumarRequest", output = "http://beans/ServiceSumarWS/sumarResponse")
    public int sumar(
